...
import com.hubtel.JsonObject.Member;
...
public class JsonObject extends JsonValue implements Iterable<Member> {
     ...
     * JSON object.
     *
     * @param object the JSON object to get the initial contents from, must not
     * be <code>null</code>
     */
     ...
     * </p>
     *
     * @param object the JsonObject for which an unmodifiable JsonObject is to
     * be returned
     ...
     * <code>null</code> if this object does not contain a member with that name
     */
