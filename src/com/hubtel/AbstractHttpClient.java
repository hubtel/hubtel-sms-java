...
import static com.hubtel.RequestHandler.UTF8;
...
public abstract class AbstractHttpClient {
    ...
    protected boolean securedConnection;
    protected static String securedProtocol = "SSL";
     ...
     * @return Response object
     */
    public HttpResponse put(String path, ParameterMap data) {
        return execute(new HttpPut(path, data));
    }
     ...
     *
     * @param path Whole or partial URL string, will be appended to baseUrl
     * @param params Additional form data
	...
	public HttpResponse postFiles(String path, ParameterMap params, UploadFile... uploadFiles) throws HttpRequestException {
        ...
        try {
            ...
            // New instance of MultipartUtility
            MultipartUtility multipart = new MultipartUtility(uc);
            ...
            for (UploadFile file : uploadFiles) {
                multipart.addFilePart(file.getFieldName(), file.getFile());
            }
    ...
    protected boolean isTimeoutException(Throwable t, long startTime) {
        ...
        if (requestLogger.isLoggingEnabled()) {
            requestLogger.log("ELAPSED TIME = " + elapsedTime + ", CT = " + connectionTimeout + ", RT = " + readTimeout);
        }
        if (isConnected) {
