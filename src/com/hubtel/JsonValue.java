/**
 * *****************************************************************************
 * Copyright (c) 2008, 2013 EclipseSource. All rights reserved. This program and
 ...
 * <strong>object</strong>, an <strong>array</strong>, a
 * <strong>number</strong>, a <strong>string</strong>, or one of the literal
 * names <strong>true</strong>, <strong>false</strong>, and
 * <strong>null</strong>.
 * <p>
 * The literal names <strong>true</strong>, <strong>false</strong>, and
 * <strong>null</strong> are represented by the constants
 * {@link #TRUE}, {@link #FALSE}, and {@link #NULL}.
 * </p>
 * <p>
 ...
 * types can be created using the public constructors.
 * </p>
 * <p>
 * Instances for JSON <strong>numbers</strong> and <strong>strings</strong> can
 * be created using the static factory methods
 ...
 * the methods
 * {@link #isObject()}, {@link #isArray()}, {@link #isString()}, {@link #isNumber()}
 * etc. can be used.
 * </p>
 * <p>
...
public abstract class JsonValue implements Serializable {
    ...
    /**
     * Returns a JsonValue instance that represents the given <code>Date</code>
     * value.
     *
     * @param value the value to get a JSON representation for
     * @return a JSON value that represents the given value
    ...
    public static JsonValue valueOf(Date value) {
        return value == null ? NULL : new JsonString(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(value));
    }
     ...
     * @throws NumberFormatException if this JSON number can not be interpreted
    ...
    /**
     * Returns this JSON value as a <code>Date</code> value, assuming this value
     * represents a JSON string. If this is not the case, an exception is
     * thrown.
     *
     * @return this value as <code>Date</code>
     * @throws UnsupportedOperationException if this value is not convertible to
     * <code>Date</code>
     */
    public Date asDate() {
    ...
    /**
     * Returns this JSON value as a <code>UUID</code> value, assuming this value
     * represents a JSON string. If this is not the case, an exception is
     * thrown.
     *
