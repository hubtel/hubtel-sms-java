...
/**
 * Represents a JSON array. A JSON array is a sequence of elements, which are
 * JSON values (see {@link JsonValue}).
 * <p>
 * Elements can be added using one of the <code>add(name, value)</code> methods.
 * Accepted values are either instances of {@link JsonValue}, strings, primitive
 * numbers, or boolean values. To replace an element of an array, the
 * <code>set(name, value)</code> methods can be used.
 * </p>
 * <p>
...
public class JsonArray extends JsonValue implements Iterable<JsonValue> {
     ...
     * @throws UnsupportedOperationException if the input does not contain a
     * JSON array
     */
    ...
    /**
     * Adds the JSON representation of the specified <code>int</code> value to
     * the array.
     *
    ...
    /**
     * Adds the JSON representation of the specified <code>long</code> value to
     * the array.
     *
     * @param value the value to add to the array
     * @return the array itself, to enable method chaining
    ...
    /**
     * Adds the JSON representation of the specified <code>float</code> value to
     * the array.
     *
     * @param value the value to add to the array
     * @return the array itself, to enable method chaining
    ...
    /**
     * Adds the JSON representation of the specified <code>double</code> value
     * to the array.
     *
     * @param value the value to add to the array
     * @return the array itself, to enable method chaining
    ...
    /**
     * Adds the JSON representation of the specified <code>boolean</code> value
     * to the array.
     *
     * @param value the value to add to the array
     * @return the array itself, to enable method chaining
     ...
     *
     * @param value the JsonValue to add to the array, must not be
     * <code>null</code>
     * @return the array itself, to enable method chaining
     */
     ...
     * <code>index < 0</code> or <code>index >= size</code>
     */
     ...
     *
     * @param index the index of the array element to replace
     * @param value the value to be stored at the specified array position, must
